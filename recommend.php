...
<?php
	...
	while ($row = mysql_fetch_assoc($result)) {
		...
		$score += 1.25 * location($usrid,$row['home'],$row['road']);   //the # of team in user's hometown included in a certain game
	...
	$r2=key($rec2);
	$r3=key($rec3);
	$sql4 = "SELECT * FROM `game4` WHERE gid = '$r1' OR gid = '$r2'OR gid = '$r3';";
